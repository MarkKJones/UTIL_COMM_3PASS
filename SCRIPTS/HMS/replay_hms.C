void replay_hms(Int_t RunNumber=0, Int_t MaxEvent=0,const char* ftype="matrixopt",const char* rtype="hms") {
  ...
  gHcParms->AddString("g_ctp_database_filename", "UTIL_COMM_3PASS/DBASE/HMS/STD/standard.database");
  ...
  gHcParms->Load("UTIL_COMM_3PASS/PARAM/TRIG/thms.param");
...
// Add Ideal Beam Apparatus
 ...
 // Define output DEF-file 
  TString DefTreeFile=Form("UTIL_COMM_3PASS/DEF-files/HMS/%s.def",ftype);
  analyzer->SetOdefFile(DefTreeFile);
 // Define cuts file
  DefTreeFile=Form("UTIL_COMM_3PASS/DEF-files/HMS/%s_cuts.def",ftype);
