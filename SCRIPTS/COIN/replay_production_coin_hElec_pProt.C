void replay_production_coin_hElec_pProt (Int_t RunNumber = 0, Int_t MaxEvent = 0,const char* ftype="coin_hElec_pProt") {
  ...
  gHcParms->AddString("g_ctp_database_filename", "UTIL_COMM_3PASS/DBASE/COIN/STD/standard.database");
  gHcParms->Load(gHcParms->GetString("g_ctp_database_filename"), RunNumber);
  gHcParms->Load(gHcParms->GetString("g_ctp_parm_filename"));
  gHcParms->Load(gHcParms->GetString("g_ctp_kinematics_filename"), RunNumber);
  gHcParms->Load(gHcParms->GetString("g_ctp_calib_filename"));
  // Load params for COIN trigger configuration
  gHcParms->Load("UTIL_COMM_3PASS/PARAM/TRIG/tcoin.param");
  // Load fadc debug parameters
  gHcParms->Load("UTIL_COMM_3PASS/PARAM/HMS/GEN/h_fadc_debug.param");
  gHcParms->Load("UTIL_COMM_3PASS/PARAM/SHMS/GEN/p_fadc_debug.param");
  ...
  CutTreeFile="UTIL_COMM_3PASS/DEF-files/COIN/CUTS/coin_production_cuts.def";
  ...
  analyzer->PrintReport("UTIL_COMM_3PASS/TEMPLATES/COIN/coin_production.template",
