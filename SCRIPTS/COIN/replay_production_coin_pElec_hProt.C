void replay_production_coin_pElec_hProt (Int_t RunNumber = 0, Int_t MaxEvent = 0,const char* ftype="coin_pElec_hProt") {
  ...
  //  DefTreeFile="DEF-files/COIN/PRODUCTION/coin_production_cuts.def";
    DefTreeFile="UTIL_COMM_3PASS/DEF-files/COIN/CUTS/coin_production_cuts.def";
  ...
  // Create report file from template
   ftype="coin_production";
  TString TemplateFile=Form("UTIL_COMM_3PASS/TEMPLATES/COIN/%s.template",ftype);
